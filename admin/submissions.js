  ...
  return `
    ...
    <div class="detail-grid">
      ...
      <div>
        ...
        <div>${customerBadge(customer.status)}</div>
      </div>
      <div>
        ...
        <p class="small">CSV source: admin email attachment</p>
      ...
      <div class="full report-panel">
        <div class="report-head">
          <div>
            <label>Upload finished report</label>
        ...
        <p class="report-note small">Upload the HTML/PDF generated locally.</p>
        <p class="report-note small">The uploaded report is what the customer receives. Generate it locally from the CSV before uploading.</p>
...
els.openManualBtn?.addEventListener('click', openManualModal);
els.closeManualBtn?.addEventListener('click', closeManualModal);
els.manualModal?.querySelector('[data-close-manual]')?.addEventListener('click', closeManualModal);
